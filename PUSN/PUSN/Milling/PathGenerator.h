...
public:
	...
	vector<Vector3> GenerateClosedSpacePaths();
	vector<Vector3> GenerateTailRosoIntersection();
	vector<vector<Vector3>> AddParametrizationLine(BezierSurfaceC0* surface, bool wdir, bool notZero, int density);
